              ...
              <thead>
                <tr className="border-b border-gray-200 text-left">
                  ...
                  <th
                    ...
                    className="cursor-pointer select-none py-2 pr-2 font-semibold text-gray-700"
                  >
                    Brand Desc <span className="text-gray-400">{sortIndicator("unitDesc")}</span>
                  </th>
                  <th
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4">
          <div className="w-full max-w-sm rounded bg-white p-4 shadow-lg">
            <h2 className="mb-3 text-sm font-semibold text-gray-800">
              {editingRow ? "Edit Brand" : "Add Brand"}
            </h2>
            <div className="space-y-3">
              <div>
                <label className="mb-1 block text-xs font-medium text-gray-600">Brand Desc</label>
                <input
                  value={form.unitDesc}
