    ...
    <div className="min-h-screen bg-gray-50 p-1">
      <div className="mx-auto  overflow-hidden rounded border border-gray-200 bg-white shadow-sm">
        ...
        <div className="flex items-center justify-between border-t-4 border-t-sky-400 bg-gray-100 px-4 py-2">
          <h1 className="text-sm font-medium text-gray-700">Product Unit</h1>
          <button
              ...
              <thead>
                <tr className="border-b border-gray-200 text-left">
                  ...
                  <th
                    ...
                    className="cursor-pointer select-none py-2 pr-2 font-semibold text-gray-700"
                  >
                    Unit Desc <span className="text-gray-400">{sortIndicator("unitDesc")}</span>
                  </th>
                  <th
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4">
          <div className="w-full max-w-sm rounded bg-white p-4 shadow-lg">
            <h2 className="mb-3 text-sm font-semibold text-gray-800">
              {editingRow ? "Edit Product Unit" : "Add Product Unit"}
            </h2>
            <div className="space-y-3">
              <div>
                <label className="mb-1 block text-xs font-medium text-gray-600">Unit Desc</label>
                <input
                  value={form.unitDesc}
